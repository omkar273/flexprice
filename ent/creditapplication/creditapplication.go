...
const (
	...
	// FieldCreditsAmount holds the string denoting the credits_amount field in the database.
	FieldCreditsAmount = "credits_amount"
...
// ByCreditsAmount orders the results by the credits_amount field.
func ByCreditsAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCreditsAmount, opts...).ToFunc()
}
