...
func (ru *RefundUpdate) SetClaimedAt(t time.Time) *RefundUpdate {
	ru.mutation.SetClaimedAt(t)
	return ru
}

// SetNillableClaimedAt sets the "claimed_at" field if the given value is not nil.
func (ru *RefundUpdate) SetNillableClaimedAt(t *time.Time) *RefundUpdate {
	if t != nil {
		ru.SetClaimedAt(*t)
	}
	return ru
...
func (ru *RefundUpdate) ClearClaimedAt() *RefundUpdate {
...
func (ru *RefundUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.ClaimedAt(); ok {
		_spec.SetField(refund.FieldClaimedAt, field.TypeTime, value)
	}
	if ru.mutation.ClaimedAtCleared() {
		_spec.ClearField(refund.FieldClaimedAt, field.TypeTime)
	}
...
// SetClaimedAt sets the "claimed_at" field.
func (ruo *RefundUpdateOne) SetClaimedAt(t time.Time) *RefundUpdateOne {
	ruo.mutation.SetClaimedAt(t)
	return ruo
}

// SetNillableClaimedAt sets the "claimed_at" field if the given value is not nil.
func (ruo *RefundUpdateOne) SetNillableClaimedAt(t *time.Time) *RefundUpdateOne {
	if t != nil {
		ruo.SetClaimedAt(*t)
	}
	return ruo
...
// ClearClaimedAt clears the value of the "claimed_at" field.
func (ruo *RefundUpdateOne) ClearClaimedAt() *RefundUpdateOne {
