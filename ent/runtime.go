...
func init() {
	...
	priceDescType := priceFields[4].Descriptor()
	...
	priceDescBillingPeriod := priceFields[5].Descriptor()
	...
	priceDescBillingPeriodCount := priceFields[6].Descriptor()
	...
	priceDescBillingModel := priceFields[7].Descriptor()
	...
	priceDescBillingCadence := priceFields[8].Descriptor()
	...
	priceDescTrialPeriod := priceFields[10].Descriptor()
	...
	priceDescEntityType := priceFields[19].Descriptor()
