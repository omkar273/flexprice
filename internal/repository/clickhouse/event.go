...
// within the specified time range. Accepts a slice so parent subscriptions with multiple
// child customers can be queried in a single round-trip instead of N separate queries.
