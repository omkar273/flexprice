...
// validateHierarchyWorkflowConflict encodes conflict rules between STANDALONE and
// hierarchy-based (PARENT/INHERITED) subscription types for a given customer.
