...
//
// PENDING denotes "claimed at insert time, gateway call about to be/being attempted" —
// not "waiting to be claimed". This is subtly different from PaymentStatus.PENDING,
// which denotes a longer-lived post-gateway-acceptance state. Both share the name
// per the spec's mirroring requirement; the semantics at the PENDING point differ.
...
// Separate from CreditNoteReason — not reused, not free text.
