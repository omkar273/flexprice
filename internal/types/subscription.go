...
type SubscriptionFilter struct {
	...
	*TimeRangeFilter
	...
	// TrialEndDueBy, when set, restricts to subscriptions with trial_end not nil and trial_end <= *TrialEndDueBy.
	// Use with subscription_status trialing for trial-end cron processing.
	TrialEndDueBy *time.Time `json:"trial_end_due_by,omitempty" form:"trial_end_due_by"`
